...
class OS_Opacity_Manager
{
    public:
        ...
        bool opacifyByControl_FullObservation(MDGraph& sog,stack<Pair> st, bdd src, bdd dest, int t, Class_Of_State* a_, bdd S , string trace );
        ...
        void computeAndOpacify_SOG_FullObservation(MDGraph& g);
