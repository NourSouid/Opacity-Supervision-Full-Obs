...
int main() {
   //write in the result file directly
	...
	cout << "***********************************************************"<< endl;
	cout << "***********************************************************"<< endl;
	cout << "      Opacify using theory of control and supervision      "<< endl;
	cout << "***********************************************************"<< endl;
	cout << "***********************************************************"<< endl;
...
*/
	strcpy(expl, "C:/Users/nours/OneDrive/Desktop/FullObservation/examples/nour/exemple3/alpha-beta.xml");
	strcpy(Obs, "C:/Users/nours/OneDrive/Desktop/FullObservation/examples/nour/exemple3/Obs.txt");
	strcpy(Int, "C:/Users/nours/OneDrive/Desktop/FullObservation/examples/nour/exemple3/Secrets.txt");
	strcpy(Int1, "C:/Users/nours/OneDrive/Desktop/FullObservation/examples/nour/exemple3/Choix.txt");
    ...
    /***create attacker***/
    int all[]= {0, 1, 2};
    int obs[]= {0, 2}; //obs by the  attacker
    set<int> transitions(obs,obs+2);//attacker's obervability
    OS_Attacker attacker ("attackerName", transitions);
    //cout<<attacker<<endl;

    /***create supervisor***/
    //controllable events are a subset of observable events
    set<int> controllableSet(obs,obs), observableSet(all,all+3);
   ...
   // g.printCompleteInformation();
    ...
    MDGraph G1;
    opacityManager.computeAndOpacify_SOG_FullObservation(G1);
    cout<<"======After opacification====== "<<endl;
